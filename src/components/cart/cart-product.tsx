    ...
    return (
        <div className="flex items-center gap-3">
            ...
            <div className="flex items-center bg-secondary p-2 rounded-md">
                <Button onClick={handleMinusClick} size={"sm"} variant={'ghost'} className="border-r rounded-none">-</Button>
                <div className="mx-3">{qt}</div>
                <Button onClick={handlePlusClick} size={"sm"} variant={'ghost'} className="border-l rounded-none" >+</Button>
            </div>
        </div>
    );
}